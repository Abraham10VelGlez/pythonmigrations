...
print("Iniciando convertidor CONSTRUCCIONES")
# ciclo x municipio
    #print("CONVERSION FINALIZADA DEL MUNICIPIO " + str(num).zfill(3) )
#!/usr/bin/python
#print("calculos")
for num in range(1, 126):
    if   num == 24  or num == 62 or num == 80 or num == 86  or num == 97 or num == 112 : #  or num == 62 or num == 80 or num == 86  or num == 97 or
        #print(str(num).zfill(3) + " Muninicio con detalles a resolver en linux")
        print("CONVERSION DETENIDA, CONTIENE ERRORES DE CONSTRUCCIONES NIVEL ESTADO DE MEXICO MUNICIPIO " + str(num).zfill(3) )
        continue
    else:
        ...
        path=str(municipiocadenaconnumeros+'/GC203T06.dbf')
        #print(path)
        # Set the name of the CSV file
        print("CARGANDO CONVERSION DE CONSTRUCCIONES NIVEL ESTADO DE MEXICO MUNICIPIO " + str(num).zfill(3) )
        csv_path = municipiocadenaconnumeros + "/construcciones.csv"
        print(csv_path)
